import Banner_1 from "./images/bannerweb-summer(1).png";
import Banner_2 from "./images/bo-my-pham-2022.jpg";
import Banner_3 from "./images/cocoon-my-pham-thuan-chay-viet-nam.jpg";
...
export const StarHalfIcon = () => {
  return (
    <svg fill="#ffce3d" width="14px" height="14px" viewBox="0 0 24 24">
